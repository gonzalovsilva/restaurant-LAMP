    ...
    <div class="row">
        ...
        <form class="col-12 col-md-6 mb-3" action="form_contact_post.php" method="post">
            <div class="form-floating mb-3">
                <input type="text" class="form-control <?php if($_SESSION['isValid'][0] == 0) echo 'border-3 is-invalid'?>" id="firstNameInput" placeholder="First Name" name="first_name" required>
                <label for="firstNameInput">First Name</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control <?php if($_SESSION['isValid'][1] == 0) echo 'border-3 is-invalid'?>" id="lastNameInput" placeholder="Last Name" name="last_name" required>
                <label for="lastNameInput">Last Name</label>
            </div>
            <div class="form-floating mb-3">
                <input type="email" class="form-control <?php if($_SESSION['isValid'][2] == 0) echo 'border-3 is-invalid'?>" id="emailInput" placeholder="name@example.com" name="mail" required>
            ...
            <div class="mt-3 form-floating">
                <textarea class="form-control <?php if($_SESSION['isValid'][3] == 0) echo 'border-3 is-invalid'?>" placeholder="Write your message here" id="textarea" name="msg" style="height: 100px" required></textarea>
        ...
        if ($_SESSION['isValid'][4] == true) { //if data was added to database
            ...
            if($_SESSION['isValid'] != [1, 1, 1, 1, false]){

                echo "<script>updateForm(false);</script>";
                $_SESSION['isValid'] = [1, 1, 1, 1, false];
            }
        }
        ?>
