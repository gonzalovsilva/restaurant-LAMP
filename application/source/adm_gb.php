...
?>
    ...
    while ($donnees = $reponse->fetch()) { ?>
        <form class="row p-1 gx-2 shadow-sm mb-1 bg-s-color" method="post">
            ...
            <input type="submit" name="gb_del" class="col-1 btn p-0 bg-p-color b-s-light shadow c-s-light b_hover" value="X" />
        </form>
    <?php } ?>
<?php } ?>
<!-- END GUEST BOOK PART -->